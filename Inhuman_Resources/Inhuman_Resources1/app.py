...
def init_db():
    ...
    employees = [
        ...
        ("Eve", "CTO", "SecurinetsENIT{D0N'T_P155_0FF_TH3_D3V}")
    ]
...
def add_employee():
    if request.method == "POST":
        ...
        # 🚨 INTENTIONAL SQL INJECTION (PHP-STYLE LOGIC) 🚨
        ...
        try:
            ...
            for row in rows:
                output += f"ID: {row['id']} | Name: {row['name']} | Position: {row['position']} | Notes: {row['notes']}<br>"
